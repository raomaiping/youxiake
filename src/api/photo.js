...
export const getPhotoH = (page)=>http("get","/special_getBkdataAjax",{
    id:1828,
    cateId:1828,
    page:page
})
...
export const getPhotoC = (page)=>http("get","/special_getBkdataAjax",{
    id:1832,
    cateId:1832,
    page:page
})
...
export const getPhotoO = (page)=>http("get","/special_getBkdataAjax",{
    id:1853,
    cateId:1853,
    page:page
})
